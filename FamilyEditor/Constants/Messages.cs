namespace MagicEntry.Plugins.FamilyEditor.Constants
{
    ...
    public static class Messages
    {
        ...
        public const string ERROR_NOT_FAMILY_OR_TEMPLATE = "Пересохранить можно только семейство или шаблон\nКоманда не выполнена";
        ...
        public const string SUCCESS_FAMILY_SAVED = "Семейство сохранено по адресу";
        public const string SUCCESS_TEMPLATE_SAVED = "Шаблон сохранен по адресу";
